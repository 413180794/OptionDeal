...
class OptionInformationModel:
    '''自动向tablewidget中插入。也许还能做更多的事情？'''

    def __init__(self, transaction_number: str, customer_name: str, contract_code: str, option_type: str,
    ...
    def insert_to_table(self, tableWidget):
        '''将数据插入到表格中'''
